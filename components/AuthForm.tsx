...
function validate(): boolean {
    ...
    if (isRegister) {
      ...
      if (accountType === "couple") {
        if (!partnerDateOfBirth) next.partnerDateOfBirth = "Bitte gib das Geburtsdatum der zweiten Person an.";
          ...
          let age = today.getFullYear() - birth.getFullYear();
          if (today < new Date(today.getFullYear(), birth.getMonth(), birth.getDate())) age--;
          if (age < 18) next.partnerDateOfBirth = "Beide müssen mindestens 18 Jahre alt sein.";
        }
      }
      if (!acceptAge)
  ...
  return (
    ...
    >
      ...
      {/* Registrierung Schritt 3: Nick, Geburtsdatum (bei Paar für beide), E-Mail, Passwort, etc. */}
