-- Aktivierung nur erlauben, wenn ein Passwort-Hash gesetzt wird oder bereits existiert.
-- Verhindert den Zustand restriction_enabled = true ohne restriction_password_hash.
