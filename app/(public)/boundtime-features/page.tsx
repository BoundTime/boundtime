    ...
    <Container className="py-16">
      <article className="prose prose-invert max-w-none">
        ...
        <ul className="mt-3 list-disc pl-6 space-y-2 text-gray-300">
          <li>
            <strong>Cuckymode</strong>: Ein Modus, der vertraglich und praktisch das Schreiben/Kommunizieren regelt,
            damit Consent und Vereinbarungen eingehalten werden.
          </li>
          <li>
            <strong>Keuschhaltungs-Vereinbarungen</strong>: Konkrete Absprachen, die beschreiben, wie
            Keuschhaltung im Alltag gelebt werden kann (z. B. Regeln, Dauer, Umsetzung).
          </li>
          <li>
            <strong>Bound-Dollars</strong>: Ein Feature rund um den Community-Kontext, das (vereinfacht gesagt)
            die „Spielregeln“ innerhalb der Plattform verständlich machen soll.
          </li>
        </ul>
